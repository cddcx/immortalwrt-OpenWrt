...
sed -i 's/("NetworkGuide")/("网络向导")/g' feeds/nas_luci/luci/luci-app-quickstart/luasrc/controller/quickstart.lua
sed -i 's/("RAID")/("磁盘阵列")/g' feeds/nas_luci/luci/luci-app-quickstart/luasrc/controller/quickstart.lua
sed -i 's/("NetworkPort")/("网口配置")/g' feeds/nas_luci/luci/luci-app-quickstart/luasrc/controller/quickstart.lua
#cp -af feeds/xiangfeidexiaohuo/linkease/nas-packages-luci/luci-app-quickstart/po/zh-cn feeds/nas_luci/luci/luci-app-quickstart/po/zh_Hans 
