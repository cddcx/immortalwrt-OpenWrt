...
sed -i 's/("QuickStart")/("首页")/g' package/nas_luci/luci-app-quickstart/luasrc/controller/quickstart.lua
sed -i 's/("NetworkGuide")/("向导")/g' package/nas_luci/luci-app-quickstart/luasrc/controller/quickstart.lua
sed -i 's/("RAID")/("磁盘阵列")/g' package/nas_luci/luci-app-quickstart/luasrc/controller/quickstart.lua
sed -i 's/("NetworkPort")/("网口配置")/g' package/nas_luci/luci-app-quickstart/luasrc/controller/quickstart.lua
