...
svn co https://github.com/yichya/openwrt-xray package/openwrt-xray
svn co https://github.com/xiechangan123/luci-i18n-xray-zh-cn package/luci-i18n-xray-zh-cn
