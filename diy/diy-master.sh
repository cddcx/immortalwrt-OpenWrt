...
sed -i 's/automount/autocore-x86 block-mount default-settings-chn luci kmod-nf-nathelper kmod-nf-nathelper-extra luci-light luci-compat luci-lib-base luci-lib-fs luci-lib-ipkg iluci-app-openclash luci-app-ssr-plus luci-app-store luci-app-udpxy luci-app-upnp/g' target/linux/x86/Makefile
